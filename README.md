...
水课管理系统是一套面向高等院校的**教学材料智能化分析与审核平台**，覆盖授课计划、教案、课件、考核方案四种教学材料的全生命周期管理。系统集成**火山引擎大语言模型**，实现 AI 自动四维评审与优化建议生成。并根据人才培养方案提供产业需求分析，帮助老师及时了解社会需求，调整授课内容，构建"教师提交→AI评审→学院主任审核→教务处终审"的完整业务闭环。

### 核心价值

- 🚀 **提升审核效率**：线上流转替代纸质审批，单次审核耗时从 3 天降至 1 天以内
- 🤖 **AI 智能评审**：大模型自动四维评分（内容完整性/与人才培养方案以及课标的匹配度/格式规范性/创新性），准确率 ≥ 85%
...
| 材料类型 | AI 评审维度 | 权重 |
|----------|-----------|:--:|
| 授课计划 | 内容完整性 / 与课标的匹配度 / 格式规范性 / 创新性 | 30%+30%+20%+20% |
| 教案 | 同上（定制化 Prompt，精准评价课堂教学设计） | 同上 |
| 课件 | 同上（关注多媒体设计、交互创新） | 同上 |
| 考核方案 | 同上（聚焦评价科学性、考核方式合理性） | 同上 |

- 4 个维度**并发调用**大模型，自动对齐人才培养方案和课程标准，90 秒内完成全部评审
